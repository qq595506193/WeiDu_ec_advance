...
import com.changhao.weidu_project.apis.CircleListApi;
...
public class CircleListModel implements ICircleListContract.ICircleListModel {
    @Override
    public void getCircleList(HashMap<String, String> params, final IRequestCallback iRequestCallback) {
        RetrofitUtils.getInstance().doGet(CircleListApi.CIRCLE_LIST_URL, params, new IOkHttpCallback() {
            @Override
